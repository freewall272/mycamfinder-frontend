<footer class="bg-gray-950 text-gray-400 border-t border-gray-800 mt-20">
  <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 gap-12 text-center sm:text-left">

    <!-- 🧭 Section 1: Navigation -->
    <div>
      <div class="border-t border-gray-200 pt-6 mb-4"></div>
      <h3 class="text-white font-semibold text-lg mb-3">Navigation</h3>
      <ul class="space-y-2">
    ...
    <div>
      ...
      <ul class="space-y-2">
        ...
        <li><a href="https://docs.google.com/forms/d/e/1FAIpQLSdrSPKQcZZeeaMclGKoQFOWh7YkjnF6GZb8ke8TAVQhuGK_yw/viewform?usp=dialog" class="hover:text-pink-400 transition">DMCA Contact</a></li>
        <li><a href="/terms" class="hover:text-pink-400 transition">Terms of Service</a></li>
